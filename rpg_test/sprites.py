...
class Player(pygame.sprite.Sprite):
    def __init__(self, game, x, y):
        self.game = game
        self._layer = PLAYER_LAYER #What layer the player appears in
        ...
        self.rect = self.image.get_rect() #hitbox and image are the same size
        self.rect.x = self.x
        self.rect.y = self.y
    ...
    def collide_blocks(self, direction):
        if direction == "x":
            hits = pygame.sprite.spritecollide(self, self.game.blocks, False) #check if player rect is inside block sprites 
            if hits:
