...
function createRandomPassword(length, includeUp, includeLow, includeNum, includeSym){
    let allCharacters = "";

    if(includeUp) allCharacters += uppercaseLetters;
...
copyButton.addEventListener("click", () => {
    ...
    navigator.clipboard.writeText(passwordInput.value).then(() => showCopySuccess());
});
